...
const navItems = [
    { name: 'Dashboard', href: '/admin_automate', icon: LayoutDashboard },
    { name: 'Users', href: '/admin_automate/users', icon: Users },
    { name: 'Subscriptions', href: '/admin_automate/subscriptions', icon: CreditCard },
    { name: 'Tiers', href: '/admin_automate/tiers', icon: Layers },
    { name: 'Feature Gates', href: '/admin_automate/gates', icon: Shield },
    { name: 'Analytics', href: '/admin_automate/analytics', icon: BarChart3 },
    { name: 'Audit Log', href: '/admin_automate/audit', icon: ScrollText },
    { name: 'Alerts', href: '/admin_automate/alerts', icon: Bell },
];
        ...
        <div className={`fixed left-0 top-0 bottom-0 z-50 flex flex-col transition-all duration-300 ${collapsed ? 'w-[72px]' : 'w-64'} bg-card-theme border-r border-theme`}>
            ...
            <div className={`flex items-center gap-3 px-5 py-5 border-b border-theme ${collapsed ? 'justify-center px-0' : ''}`}>
                    <div className="w-8 h-8 relative flex-shrink-0">
                        <Image src="/logo/NYX-Logo.png" alt="NYX Studio logo" width={120} height={40} className="h-full w-full object-contain" sizes="32px" unoptimized />
                    </div>
                {!collapsed && (
                    <div>
