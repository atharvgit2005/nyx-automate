    ...
    return (
        <div className="space-y-8">
            <div className="flex items-start justify-between">
                ...
                <Link href="/automate/admin_automate/subscriptions" className="text-xs px-4 py-2 rounded-lg bg-card-theme border border-theme text-theme-secondary hover:text-theme-primary hover:bg-accent transition flex items-center gap-2">
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="space-y-2">
                    ...
                    {[
                        { label: 'Review Pending Approvals', href: '/automate/admin_automate/subscriptions', badge: pendingCount },
                        { label: 'Feature Gate Control', href: '/automate/admin_automate/gates', badge: 0 },
                        { label: 'View Audit Log', href: '/automate/admin_automate/audit', badge: 0 },
                        { label: 'Configure Alerts', href: '/automate/admin_automate/alerts', badge: 0 },
                ...
                <div className="col-span-2 rounded-2xl border border-theme bg-card-theme p-5">
                    ...
                    <Link href="/automate/admin_automate/audit" className="mt-4 text-xs text-orange-500 hover:text-orange-400 flex items-center gap-1 transition">View full log <ChevronRight className="w-3 h-3" /></Link>
                </div>
            </div>
        </div>
    );
