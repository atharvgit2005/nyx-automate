    ...
    return (
        <div className="min-h-screen bg-page flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h1 className="mt-6 text-center text-3xl font-extrabold text-theme-primary">
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-card-theme py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-theme">
                    <form className="space-y-6" onSubmit={handleLogin}>
                        {displayError && (
                            <div className="bg-red-500/10 border border-red-500 text-red-500 px-4 py-2 rounded text-sm text-center" aria-live="polite">
                                {displayError}
                            </div>
                        )}
                        <div>
